...
{
int id1;
char name[20],age[20],city[20],dis[20],room[20],sym[20],con[20],date[20],

charg[20],bill[20];
};

using namespace std; class doctor;
class patient; class hospital
{
public:
...
public:
int docid=0;
struct doctor1 arr[10]; void add_doc_info()
{
int i,en;
cout<<"How Many Entries you want to add :"; cin>>en;
for(i=1;i<=en;i++)
{
cout<<"Enter Doctor's ID	:"; cin>>arr[docid].id;
cout<<"Enter Doctor's Name	:"; cin>>arr[docid].name;
cout<<"Enter Doctor's Age	:"; cin>>arr[docid].age;
cout<<"Enter Doctor's Qualification	:"; cin>>arr[docid].Q;
cout<<"Enter Doctor's Specialization	:"; cin>>arr[docid].special;
cout<<"Enter Doctor's Experience	:"; cin>>arr[docid].exp;
cout<<"Enter Doctor's city	:"; cin>>arr[docid].city;
docid++; counter++; cout<<"\n";
...
int n,i;
cout<<"\n Enter the doctor's ID to display Record :"; cin>>n;
if(n==0)
{
cout<<"\n\n	OOPS!!!!	"<<"\n\n";
...
{
int status=0; for(i=0;i<docid;i++)
{
if(arr[i].id==n)
{
status=1; break;
...
cout<<"ID"<<"\t \t"<<"specialization"<<"\t \t"<<"Qualification"<<"\t \t"<<"Age"; cout<<"\n \n";

for(i=0;i<docid;i++)
{
cout<<arr[i].id<<"\t \t"<<arr[i].special<<"\t \t \t"<<arr[i].Q<<"\t \t
\t"<<arr[i].age<<"\n";
}
...
void add_pat_info(); void Display();
void patient_report(); void patient_detail(); void tot_no_of_pat(); void gen_pat_report();
};
...
for(i=1;i<=en;i++)
{
cout<<" 1.Enter Patient's ID	:"; cin>>arr[docid1].id1;
cout<<" 2. Enter patient's Name	:"; cin>>arr[docid1].name;
cout<<"3. Enter patient's Age	:"; cin>>arr[docid1].age;
cout<<" 4. Enter patient's Disease	:"; cin>>arr[docid1].dis;
cout<<" 5. Enter patient's Symptoms	:"; cin>>arr[docid1].sym;
cout<<" 6. Enter Patient's Room No.	:"; cin>>arr[docid1].room;
cout<<" 7. Enter Patient's condition Before Admit	:"; cin>>arr[docid1].con;
cout<<" 8. Enter Patient's ADMIT Date	:"; cin>>arr[docid1].date;
cout<<" 9. Enter Patient's Room Charge	:"; cin>>arr[docid1].charg;
cout<<" 10. Enter Patient's Medicine charge	:"; cin>>arr[docid1].bill;
docid1++; counter++; cout<<"\n";
...
{
int n,i;
cout<<"\n Enter the Patient's ID to display info :"; cin>>n;
if(n==0)
{
cout<<"\n\n	OOPS!!!!	"<<"\n \n";
cout<<"Note:- No Record To Display Plz Go Back And Enter Some Entries.	"<<"\n";
...
{
int status=0; for(i=0;i<docid1;i++)
{
if(arr[i].id1==n)
{
status=1; break;
...
int i,n;
cout<<"\n Enter the Patient's ID to Display Report :"; cin>>n;
int status=0; for(i=0;i<docid1;i++)
{
if(arr[i].id1==n)
{
...
int i,n;
cout<<"\n Enter the Patient's ID to Display Bill :"; cin>>n;
int status=0; for(i=0;i<docid1;i++)
{
if(arr[i].id1==n)
{
...
bool repeat= true; int ch1,ch2,ch3,ch4; doctor d;
patient p; xyz:
...
cout<<"\n\n";
cout<<"   1.   Enter into Doctor's	DataBase "<<endl; cout<<" 2. Enter into Patient's DataBase "<<endl; cout<<"  3.  Generate	Patient's  Report		"<<endl; cout<<"  4.  Generate	Patient's  Bill	"<<endl; cout<<"  5.  EXIT			"<<"\n";
...
cout<<"Please Enter your choice :"<<" "; cin>>ch3;
switch(ch3)
{
case 1: d.add_doc_info(); break;
case 2:
d.Display(); cout<<"\n";
break; case 3:
d.doctor_detail(); break;

case 4:
d.tot_no_of_doc(); break;
...
cout<<"Please Enter your choice :"<<" "; cin>>ch4;
switch(ch4)
{
case 1:

p.add_pat_info(); break;
case 2:
p.Display(); cout<<"\n";
break;

case 3:
p.patient_detail(); break;

case 4:
p.tot_no_of_pat(); break;
